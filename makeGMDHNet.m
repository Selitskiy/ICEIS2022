function [regNet, cgraph] = makeGMDHNet(i, m_in, n_out, k_hid1, k_hid2, accTarget1, accTarget2, lMax, mb_size, X, Y)
...
'MaxEpochs',250);  
    ...
    [cgraph, regNet, ll, k_hid1_real, curGMDHLayerName, curGMDHRegressionName] =... 
        gmdhLayerGrowN(cgraph, prevLayerName, sOptions, X, Y, m_in, i, n_out, ll, accTarget1, max_neuro1, min_neuro1, dAccMin, lMax);
    ...
    if(k_hid1_real > 1)
        ...
        [cgraph, regNet, ll, k_hid2_real, curGMDHLayerName, curGMDHRegressionName] =... 
            gmdhLayerGrowN(cgraph, prevLayerName, sOptions2, X, Y, k_hid1_real, i, n_out, ll, accTarget2, max_neuro2, min_neuro2, dAccMin, lMax);
        prevLayerName = curGMDHLayerName;
